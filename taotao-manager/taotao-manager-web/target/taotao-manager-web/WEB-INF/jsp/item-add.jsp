...
<link href="${shop }/js/kindeditor-4.1.10/themes/default/default.css"
	type="text/css" rel="stylesheet">

<script type="text/javascript" charset="utf-8"
	src="${shop }/js/kindeditor-4.1.10/kindeditor-all-min.js"></script>
<script type="text/javascript" charset="utf-8"
	src="${shop }/js/kindeditor-4.1.10/lang/zh_CN.js"></script>
	...
	<form id="itemAddForm" class="itemForm" method="post">
		<table cellpadding="5">
			<tr>
				<td>商品类目:</td>
				<td>
					<!-- 商品類目使用easyui的異步tree來實現的 --> <a href="javascript:void(0)"
					class="easyui-linkbutton selectItemCat">选择类目</a> <input
					type="hidden" name="cid" style="width: 280px;"></input>
				</td>
			</tr>
			<tr>
				<td>商品标题:</td>
...
<script type="text/javascript">
	...
	$(function() {
		...
		//TT.kingEditorParams应该是为了上传文件用的
		//初始化类目选择和图片上传器
		TAOTAO.init({
			fun : function(node) {
